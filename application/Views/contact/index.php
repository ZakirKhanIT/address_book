                            ...
                            ?><tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="...">
                                        <a href="?action=contact/edit&id=<?=$contact['id'];?>" class="btn btn-custom"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                                        <a href="?action=contact/delete&id=<?=$contact['id'];?>" class="btn btn-custom"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; 
