...
<div class="container">
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            <form class="form-horizontal" method="POST" action="?action=tag/edit">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" required class="form-control" id="tagName" name="tagName"
                            value="<?=$tags['name'];?>">
                    </div>
                </div>
                <div class="form-group">
                    <div class=" col-sm-10 col-sm-offset-2">
                        <a href="<?php echo PATH_ADDRESS ?>?action=tag" class="btn btn-default"><span
