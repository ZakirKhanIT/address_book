...
function errorMessages(){
    $error = [];
    $error['info'] = 'Table  will be auto created with dummy data while creating the database<br> for information adding the snippets of query<br/>
    ...
    <tbody>
            ...
            city_id 
                    ...
                    ("Zack","Rohe","zack@gmail.com","street 49","23456",4)</td></td>
        </tr>
        <tr>
        <td>2</td>
        <td>City</td>
        <td>CREATE TABLE IF NOT EXISTS `city` (
            ...
            `created_date` timestamp NOT NULL DEFAULT current_timestamp(),
            `updated_date` timestamp NOT NULL DEFAULT current_timestamp(),
            PRIMARY KEY(`id`)</td><td>INSERT INTO city(
                name
                ) 
